...
MANUALLY_EXCLUDED_NAMES = {
    ...
    "tbn україна",
    "aghapy kids", "al horreya tv", "al-fady tv", "al-mahditv",
    "alhurra iraq", "alkarma tv australia", "alkarma tv family",
    "alkarma tv middle east", "alkarma tv north america & canada",
    "alkarma tv praise", "alkarma tv talmaza", "almagd tv middle east",
    "almagd tv north america", "elbeshara gtv", "lbc international",
    "artn tv", "avang tv", "didgah tv", "ganj e hozour tv",
    "mohabat tv", "omide iran", "payam-e-afghan tv",
    "payame aramesh tv", "payvand tv", "pbc tapesh tv", "pars tv",
    "shabakeh 7", "tapesh 2", "velayat tv", "zarin tv",
    "aliento vision", "babytv latin america", "canela.tv",
    "cbn espanol", "cine adrenalina", "cine amor", "cine aventura",
    "cine comedia", "cine premiere", "cine sony", "cine terror",
    "el reino infantil", "investiga", "kftr-dt1", "kmex-dt1",
    "krca-tv estrella los angeles", "krgv-dt2", "ksce vida cristiana",
    "kuvn-dt1", "logos tv salud", "los nuevos detectives",
    "ministerio la voz de un remanente tv", "minuto para ganar",
    "misterios medicos", "misterios sin resolver",
    "once ninas y ninos", "pluto tv novelas", "runtime espanol",
    "semillitas tv", "telemix", "tln media chicago",
    "tln media san francisco", "turismo hd", "tv hispanic",
    "tv quisqueya", "tve internacional america",
    "tve internacional america hd", "tyc sports usa", "vida mejor tv",
    "wfut-dt1", "wltv-dt1", "wxtv-dt1", "comercio tv", "extrema tv",
    "metaleitor tv", "tele boston", "teve vida network", "ntd tv",
    "ntd tv west", "rtr-planeta us", "rtvi us", "тнт international",
    "hmong star tv", "kajou tv", "tv panou", "zoom tv kurdish",
    "mediaset italia usa", "sanskar usa", "swamiji tv american",
    "amg tv", "assyriasat", "amga tv", "cafe trade tv", "csat tv",
    "filamtv network", "geb tv", "globalworldtv", "gmtv", "homeful",
    "infast", "lgtv", "mtc tv", "redseat the first", "tele pam",
    "tv daja", "voa tv africa",
}
